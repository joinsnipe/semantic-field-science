...
## SEO ESTRATÉGICO — POSICIONAMIENTO ORGÁNICO

### El problema de partida

El dominio semanticfieldscience.org lleva 2 meses activo con ~560 impresiones
totales y 4 clics. Las queries actuales que generan tráfico son búsquedas del
nombre propio del modelo (MCSH) — nadie externo busca eso todavía.

El observatory debe posicionarse para búsquedas con demanda real existente:

### Keywords objetivo primarias (alta demanda, alta relevancia):

- "riesgo sistémico 2026"
- "burbuja financiera 2026"
- "crisis financiera cuando"
- "fragilidad sistema financiero global"
- "probabilidad crisis economica 2026"

### Keywords objetivo secundarias (media demanda):

- "crédito consumo España crisis"
- "absentismo laboral España 2025 2026"
- "modelo Markov riesgo sistémico"
- "burbuja sintética economía"
- "indicadores crisis financiera no convencionales"

### Keywords de cola larga (baja competencia, alta conversión):

- "cuando va a explotar la burbuja financiera"
- "señales crisis financiera global 2026"
- "fragmentación mercados financieros riesgo"
- "Commercial Real Estate colapso contagio"
- "repo market fragility 2026"

### Implementación técnica SEO completa:
...
- description: "Monitor cuantitativo de riesgo sistémico global.
  Modelo Markov + Monte Carlo. Probabilidad crisis 12 meses: 72.7%.
  10 indicadores no convencionales. Actualización mensual."
- og:title: "¿Cuándo explota la burbuja? Un modelo lo mide."
- og:description: "α=0.776 · Estado S1′ · T_med=3.1 meses.
  El sistema no está estable: está contenido artificialmente."
- og:image: imagen generada con los 3 números grandes sobre fondo oscuro
- Twitter card: summary_large_image

/observatory/indicators

- title: "10 Indicadores de Riesgo Sistémico que Nadie Monitoriza · SFS Observatory"
- description: "Gamma squeeze risk, liquidity illusion, repo fragility,
  narrative desperation index: los indicadores que los dashboards
  institucionales no publican. Datos y metodología completa."

/observatory/casestudy

- title: "Burbuja Sintética 2026: Caso de Estudio sobre Fragilidad Sistémica"
- description: "Análisis técnico completo: modelo Markov 7 estados,
  Monte Carlo n=10.000, 10 indicadores, micro-fisuras activas y
  ventana de convergencia mayo 2026."

/observatory/methodology

- title: "Metodología: Modelo MCH + Markov para Riesgo Sistémico · SFS"
- description: "Framework teórico completo. Estado S1′ (burbuja sintética),
  función logística de calibración, protocolo Comparator y
  condiciones de invalidación del modelo."

#### Structured Data (JSON-LD) en cada página:

- Schema Article para el caso de estudio
- Schema Dataset para los indicadores (con dateModified actualizable)
- Schema Person para Rubén Abella como autor
- Schema Organization para Semantic Field Science
- Schema FAQPage en methodology con las preguntas frecuentes

#### Arquitectura de links internos:

- Hero → enlaza a /indicators y /casestudy con anchor text descriptivo
- Cada indicador en la home → enlaza a /indicators#nombre-indicador
- Cada sección del caso de estudio → enlaza a /methodology#sección
- Footer → enlaza a semanticfieldscience.org (dominio raíz MCSH)
- Breadcrumbs visibles en todas las subrutas

#### Sitemap.xml y robots.txt:

Genera automáticamente sitemap.xml con todas las rutas y
robots.txt permitiendo todo el crawleo.

#### Contenido optimizado para búsqueda:

En /observatory/casestudy publicar el caso de estudio completo
como HTML semántico correcto:

- H1 único: "Burbuja Sintética: Caso de Estudio sobre Fragilidad Sistémica Global"
- H2 para cada parte del documento
- H3 para subsecciones
- Las tablas como <table> semántico real (no imágenes)
- Los datos numéricos en <strong> o <data> según contexto
- Alt text descriptivo en todos los elementos visuales

#### Internacionalización preparada:

- hreflang ES y EN desde el inicio
- /observatory en español (audiencia principal actual: España + LATAM)
- /en/observatory en inglés (para capturar tráfico angloparlante)
- Mismo contenido traducido, no duplicado

#### Core Web Vitals:

- LCP < 2.5s: hero sin imágenes pesadas, solo texto y números
- CLS = 0: reservar espacio para gráficos antes de cargar
- FID < 100ms: interacciones de charts con lazy load
- Implementar next/font para zero layout shift en tipografías

#### Open Graph para compartir en redes:

Crear componente OGImage dinámico con next/og que genere
automáticamente imagen con:

- Fondo oscuro #0a0a0f
- Los 3 números grandes: α=0.776 | S1′ | T_med=3.1m
- Logo SFS Observatory
- Fecha de actualización
  Esto maximiza el CTR cuando se comparte en LinkedIn o Twitter.

#### Estrategia de contenido para autoridad de dominio:

Crear en /observatory/updates una sección de actualizaciones
mensuales tipo changelog:

- "Actualización 7 mar 2026: α sube a X, T_med cambia a Y"
- Formato: fecha + los 3 números + interpretación en 3 líneas
- Cada actualización es una URL indexable nueva
- Genera señales frescas para Google y razón de volver

#### Analytics preparado:

- Instalar next/third-parties para Google Analytics 4
- Eventos custom:
  - click en cada indicador → "indicator_view"
  - scroll a sección PNR → "pnr_reached"
  - click en caso de estudio → "casestudy_open"
  - click en methodology → "methodology_open"
- Estos eventos permiten saber qué engancha más
